	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Charity Fund</h2>
				<p>A way to Purify yourself and your Wealth</p>
				<br><br>
				<center>
		...
		<!-- One
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>Charity Fund</h2>
						<p>Explore the new way of funding...</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Charity Fund &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">A way to Purify yourself and your Wealth</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">HKBK College of Engineering<span>Bangalore</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">8073552397</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="https://hkbk.edu.in/" style="color:white"><u>hkbk.edu.in</u></a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Charity Fund</b></span>
				AgroCulture is platform using which you can donate your wealth to the needy once!! 
			</p>
			<div class="footer-icons">
				<a  href="https://zoma.to/u/171599181"><i style="margin-left: 0;margin-top:5px;"class="fa fa-facebook"></i></a>
				<a href="https://instagram.com/qfoodiz?igshid=u67gz0j55j9x"><i style="margin-left: 0;margin-top:5px" class="fa fa-instagram"></i></a>
				<a href="https://youtu.be/aN-fbDTA9GY"><i style="margin-left: 0;margin-top:5px" class="fa fa-youtube"></i></a>
			</div>
		</div>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
			                        ...
			                        <div class="3u 12u$(small)">
			                            <input type="radio" id="farmer" name="category" value="1" checked>
			                            <label for="farmer">New User</label>
			                        </div>
